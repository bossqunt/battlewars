...
LOCK TABLES `item_rarities` WRITE;
/*!40000 ALTER TABLE `item_rarities` DISABLE KEYS */;
INSERT INTO `item_rarities` VALUES (1,'Common',90),(2,'Rare',20),(3,'Epic',5),(4,'Legendary',1),(5,'Godly',0.2);
/*!40000 ALTER TABLE `item_rarities` ENABLE KEYS */;
UNLOCK TABLES;
